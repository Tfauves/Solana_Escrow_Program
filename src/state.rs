...
impl Pack for Escrow {
    // calculated by by adding the sizes of the individual data types in the escrow struct
    const LEN: usize = 105;
    // turns an array or u8 into an instance of the escrow struct
    ...
    fn unpack_from_slice(src: &[u8]) -> Result<Self, ProgramError> {
        ...
        let (
            ...
            expected_amount,
            // 1 is bool 3x32 are the pubkey, 8 is for the u64
